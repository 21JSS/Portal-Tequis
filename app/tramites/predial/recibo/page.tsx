...
import { CheckCircle2, Printer, Home, Copy, Landmark, CreditCard, FileText, ExternalLink } from 'lucide-react'
  ...
  return (
    <DashboardLayout>
      <div className="max-w-2xl mx-auto space-y-6 print:space-y-0">
        ...
        {/* Banner de Factura SAT (solo si pagó con tarjeta) */}
        {metodo === 'tarjeta' && (
          <div className="bg-white rounded-2xl p-5 shadow-xs border border-slate-200/80 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 print:hidden">
            <div className="flex items-center gap-3.5">
              ...
              <div>
                <div className="flex items-center gap-2">
                  <h3 className="font-bold text-sm sm:text-base text-slate-800">¿Requiere Factura Fiscal (CFDI)?</h3>
                ...
                <p className="text-xs text-slate-500 mt-0.5 max-w-md">
                  Al pagar con tarjeta puede emitir su factura fiscal electrónica directamente a través del portal oficial del SAT.
                </p>
              </div>
            </div>
            <a
              id="btn-generar-factura-banner"
              href="https://www.sat.gob.mx/personas/factura-electronica"
              target="_blank"
              rel="noopener noreferrer"
              className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-5 py-2.5 rounded-xl bg-emerald-600 hover:bg-emerald-700 text-white text-sm font-semibold shadow-md shadow-emerald-600/20 hover:shadow-lg hover:-translate-y-0.5 transition-all duration-200 shrink-0"
            >
        ...
        <div className="flex flex-wrap items-center gap-3 print:hidden">
          ...
          >
            <Printer className="w-4 h-4 text-[#8e1432]" />
